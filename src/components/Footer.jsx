  ...
  return (
    <div className='bg-black text-white p-6 pb-0'>
      ...
      <div className="about-section2 m-4 p-4 md:w-2/3 md:p-4">
        <div className='text-[22px] font-bold my-4 md:text-3xl lg:text-4xl w-max'>Seamless Transaction. <br /> Enjoy Innovation</div>
      ...
      <div className="footer3 text-gray-500 font-extrabold w-full text-center text-8xl">SWIFTPAY</div>
