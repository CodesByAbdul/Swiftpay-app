  ...
  return (
    <div className='mt-8 p-6 md:flex md:justify-between md:gap-2 md:items-center'>
      <div className="about-section2 m-4 md:w-full md:h-[80vh] md:p-4">
        ...
        <div className='text-[5vw] font-semibold my-4 md:text-3xl lg:text-4xl w-max'>Stay in control of your Finances.</div>
      ...
      <div className='w-full mx-auto rounded-2xl overflow-y-hidden md:h-[80vh] bg-[#ececec] pt-15 md:pt-30'><img className='w-ful h-full m-auto' src="/assets/iMockup.png" alt="" /></div>
    </div>
  )
}
