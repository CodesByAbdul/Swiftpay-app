  ...
  return (
    <div className='text-center pt-20'>
      ...
      <div className='w-[60%] m-auto md:flex md:justify-between md:items-center md:gap-2'>
        <div className='p-2'>
          <img className='w-full m-auto my-2' src="/assets/Frame5.png" alt="" />
          <p>Target Savings</p>  
        </div>
        <div className='p-2'>
          <p>Send funds & PayBills</p>  
          <img className='w-full m-auto my-2' src="/assets/Frame6.png" alt="" />
        </div>
        <div className='p-2'>
          <img className='w-full m-auto my-2' src="/assets/Frame7.png" alt="" />
          <p>AI assistant</p>  
        </div>
      </div>
    </div>
