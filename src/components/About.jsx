  ...
  return (
    <div className='about md:flex md:justify-between md:items-center md:gap-4 text-black p-6 md:pt-20 md:h-screen mb-4 md:mb-8'>
      <div className="about-section1 p-4 bg-[#ececec] md:w-full rounded-lg shadow-lg">
        <div className=" md:flex md:justify-start md:items-center gap-3 md:mb-12">
          ...
          <p className='text-sm ml-2'>Join over 2000+ active and happy users</p>
        </div>
        ...
        <div className="flex justify-between items-center gap-6 m-2 mt-6">
          <div className="bg-white text-black rounded-xl h-38 p-6 w-full">
      ...
      <div className="about-section2 m-4 md:w-full md:p-4">
        ...
        <div className='my-6 md:my-10'>
          <div className="flex gap-2 mb-2 text-sm"><img className='w-4' src="/assets/magic-wand-01.svg" alt="" /> <p>Artificial Intelligence assistant</p></div>
          <div className="flex gap-2 mb-2 text-sm"><img className='w-4' src="/assets/renewable-energy-01.svg" alt="" /> <p>Savings and Target Savings</p></div>
          <div className="flex gap-2 mb-2 text-sm"><img className='w-4' src="/assets/security-check.svg" alt="" /> <p>Two Factor Authentication Protection</p></div>
          <div className="flex gap-2 mb-2 text-sm"><img className='w-4' src="/assets/rocket-01.svg" alt="" /> <p>Swift and Seamless Transaction</p></div>
          <div className="flex gap-2 mb-2 text-sm"><img className='w-4' src="/assets/navigation-04.svg" alt="" /> <p>Global Reach</p></div>
        </div>
